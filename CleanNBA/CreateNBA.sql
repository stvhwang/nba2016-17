...
CREATE TABLE IF NOT EXISTS da_nba.game0021600050 (
...
DELETE FROM da_nba.game0021600050;

-- UPDATE THIS PATH:
COPY da_nba.game0021600050 FROM '/Users/shwang/Documents/Data Analytics Class/NBA/Data2016-17/0021600050.csv'
